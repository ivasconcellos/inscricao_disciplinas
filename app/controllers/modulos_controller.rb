class ModulosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @modulo.save
        format.html { redirect_to modulo_url(@modulo), notice: "Módulo cadastrado com sucesso!" }
  ...
  def update
    respond_to do |format|
      if @modulo.update(modulo_params)
        format.html { redirect_to modulo_url(@modulo), notice: "Módulo atualizado com sucesso!" }
  ...
  private
    ...
    def modulo_params
      params.require(:modulo).permit(:nome, :ativo)
    end
end

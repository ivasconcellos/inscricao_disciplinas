...
class DisciplinasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create disciplina" do
    assert_difference('Disciplina.count') do
      post disciplinas_url, params: { disciplina: { ativa: @disciplina.ativa, nome: @disciplina.nome, tipo: @disciplina.tipo, turma_id: @disciplina.turma_id } }
    end
  ...
  test "should update disciplina" do
    patch disciplina_url(@disciplina), params: { disciplina: { ativa: @disciplina.ativa, nome: @disciplina.nome, tipo: @disciplina.tipo, turma_id: @disciplina.turma_id } }

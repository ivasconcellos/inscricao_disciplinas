...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { ativa: @turma.ativa, curso_id: @turma.curso_id, modulo_id: @turma.modulo_id, nome: @turma.nome } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { ativa: @turma.ativa, curso_id: @turma.curso_id, modulo_id: @turma.modulo_id, nome: @turma.nome } }

...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { ativo: @curso.ativo, local_id: @curso.local_id, nome: @curso.nome } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { ativo: @curso.ativo, local_id: @curso.local_id, nome: @curso.nome } }
